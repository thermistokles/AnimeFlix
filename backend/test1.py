...
# Load the model
mapping_dict = torch.load('C:/Users/vigne/Downloads/AnimeFlix-main/AnimeFlix-main/mapping.pth')
...
model.load_state_dict(torch.load('C:/Users/vigne/Downloads/AnimeFlix-main/AnimeFlix-main/model.pth'))
model.eval()
